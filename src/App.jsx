...
function CustomCampaignCard({ campaign, clients, activity, onUpdateStage, onView, onRemove, onUpdateEmail, onUpdateCampaign, autoExpand }) {
  ...
  return (
    <div style={{
      ...
      {expanded && (
        <div style={{ borderTop: `1px solid ${COLORS.line}`, background: COLORS.cream, padding: '14px 22px 18px' }}>
          {isScheduledFuture && !editingDetails && (
            <div style={{
              display: 'flex', alignItems: 'center', gap: 10, background: 'rgba(167,150,217,0.12)',
              border: `1px solid ${COLORS.lavender}`, borderRadius: 10, padding: '10px 16px', marginBottom: 16,
            }}>
